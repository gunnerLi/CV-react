    ...
    render(){
        ...
        return(
            <section className="job">
               <div className="row">
                     <div className="col-1">时&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;间:</div>
                     <div className="col-11">{jobs.time}</div>
               </div> 
               <div className="row">
                     <div className="col-1">所在公司:</div>
                    <div className="col-11">{jobs.company}</div>
               </div> 
               <div className="row">
                     <div className="col-1">项目名称:</div>
                    <div className="col-11">{jobs.project}</div>
               </div> 
                <div className="row">
                     <div className="col-1">项目简介:</div>
                    <div className="col-11">{jobs.descript}</div>
               </div>
                <div className="row">
                     <div className="col-1">职责描述:</div>
                    <div className="col-11">{jobs.duty}</div>
               </div>
               <div className="row">
                     <div className="col-1">主要技术:</div>
                    <div className="col-11">{jobs.technology}</div>
               </div>
               <div className="row">
                     <div className="col-1">离职原因:</div>
                    <div className="col-11">{jobs.reason}</div>
               </div>  
            </section>
        )
    }
