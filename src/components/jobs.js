...
let jobs = [{
    ...
    reason:'考虑到家庭因素，希望能够离家近一些。同时自己希望能够在北京学到更多的知识，认识更多的朋友，找到更具有挑战性的工作'
}]
    ...
    render(){
        ...
        return(
            <section className="job">
               <div className="row">
                     <div className="title">时&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;间:</div>
                     <div className="dist">{jobs.time}</div>
               </div> 
               <div className="row">
                     <div className="title">所在公司:</div>
                    <div className="dist">{jobs.company}</div>
               </div> 
               <div className="row">
                     <div className="title">项目名称:</div>
                    <div className="dist">{jobs.project}</div>
               </div>  
               <div className="row"> 
                     <div className="title">项目主页:</div>
                    <div className="dist"><a href={jobs.link} target="_blank">{jobs.link.slice(7)}</a></div>
               </div> 
                <div className="row"> 
                     <div className="title">项目简介:</div>
                    <div className="dist">{jobs.descript}</div>
               </div> 
                <div className="row"> 
                     <div className="title">职责描述:</div>
                    <div className="dist">{jobs.duty}</div>
               </div> 
               <div className="row"> 
                     <div className="title">主要技术:</div>
                    <div className="dist">{jobs.technology}</div>
               </div> 
               <div className="row"> 
                     <div className="title">离职原因:</div>
                    <div className="dist">{jobs.reason}</div>
               </div>  
            </section>
        )
    }
